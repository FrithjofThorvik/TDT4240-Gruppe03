 ...
 * TODO: Implement working state functionality
 **/
public class GameStateManager {
    ...
    public GameStateManager(ImmutableArray<Entity> players, ImmutableArray<Entity> timers) {
    ...
    private void initGameStates() {
        ...
        this.gameStates.put(STATE.PLAY_ROUND, new RoundPlay(this));
        this.gameStates.put(STATE.SWITCH_ROUND, new RoundSwitch(this));
    }
